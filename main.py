...
nationality_list = db_helper.select_nationalities()
...
# Select Events Data
championship_list = db_helper.select_championships()
event_ids_dict = db_helper.select_events(start_season)
...
# Results
events_list = db_helper.select_events_without_results()
result_page.insert_results(events_list)

# Select Entries Data
driver_list = db_helper.select_drivers()
codriver_list = db_helper.select_codrivers()
